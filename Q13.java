...
class Q13 {
    ...
    public static void main(String args[]) {
        ...
        if (Integer.valueOf(numstr) < 1000  && numstr.length() > 0) {
            numberToWords(numstr.toCharArray());
        } else if (numstr.length() == 0) {
            System.out.println("The string is empty.");
        }else {
            System.out.println("The number is not in the range of 0 to 999");
        }
    }
}
...
Enter the number: 
17001
The number is not in the range of 0 to 999
 */